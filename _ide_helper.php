...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function addItemType($name, $fields = [])
        {
                        /** @var \RyanChandler\FilamentNavigation\FilamentNavigationManager $instance */
                        return $instance->addItemType($name, $fields);
        }
                    /**
         * 
         *
        ...
        public static function macro($name, $macro)
        {
                        \RyanChandler\FilamentNavigation\FilamentNavigationManager::macro($name, $macro);
        }
                    /**
         * Mix another object into the class.
         *
        ...
        public static function mixin($mixin, $replace = true)
        {
                        \RyanChandler\FilamentNavigation\FilamentNavigationManager::mixin($mixin, $replace);
        }
                    /**
         * Checks if macro is registered.
         *
        ...
        public static function hasMacro($name)
        {
                        return \RyanChandler\FilamentNavigation\FilamentNavigationManager::hasMacro($name);
        }
                    /**
         * Flush the existing macros.
         *
        ...
        public static function flushMacros()
        {
                        \RyanChandler\FilamentNavigation\FilamentNavigationManager::flushMacros();
        }
...
namespace  { 
            ...
            class FilamentNavigation extends \RyanChandler\FilamentNavigation\Facades\FilamentNavigation {}
